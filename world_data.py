"""World objects and map data for GV Zork.
...
mr_w = NPC(
    "Mr. W",
    (
        "Mr. W is a professor at GVSU, he is very "
...
troy = NPC(
    "Troy",
    (
        "Troy is a cybersecurity student who seems "
...
william = NPC(
    "William",
    (
        "William is a computer science student "
        "who appears oddly calm despite the frozen campus."
    ),
)
william.add_message(
    "The elf will only save campus if it gets enough calories."
)
...
tyler = NPC(
    "Tyler",
    (
        "Tyler is a computer science student studying in the library. "
...
coach = NPC(
    "Coach",
    (
        "The Fieldhouse coach watches over the athletic "
...
elf = NPC(
    "Elf",
    (
        "A magical elf who lives in the ravines beneath "
...
henry = Location(
    "Henry Hall",
    (
        "Henry Hall is an academic building "
...
forest = Location(
    "Campus Ravines",
    (
        "Below the Little Mac Bridge lies "
